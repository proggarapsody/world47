...
const Loading: React.FC = () => {
  const like = (e: React.MouseEvent<HTMLElement>) => {
    ...
    return target.classList.value === 'fa-regular fa-heart like'
      ? (target.classList.value = 'fa-solid fa-heart like text-danger')
      : (target.classList.value = 'fa-regular fa-heart like')
  }
